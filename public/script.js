        ...
        return `
            <div class="job-card">
                ...
                <div class="job-actions">
                    <a href="${job.ref}" target="_blank" class="btn btn-primary">
                        <i class="fas fa-external-link-alt"></i>
                        Ver Vaga
                    </a>
                    <button class="btn btn-secondary" onclick="navigator.share ? navigator.share({title: '${job.name}', url: '${job.ref}'}) : this.copyToClipboard('${job.ref}')">
